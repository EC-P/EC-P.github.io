...
(function() {
  ...
  window.onclick = function(event) {
    var a = new Array("H", "氢","He", "氦","Li", "锂","Be", "铍", "B", "硼","C", "碳",
      "N", "氮","O", "氧", "F", "氟","Ne", "氖", "Na", "钠", "Mg", "镁","Al", "铝","Si", "硅",
      "P", "磷","S", "硫","Cl", "氯","Ar", "氩","K", "钾","Ca", "钙","Sc", "钪","Ti", "钛",
      "V", "钒","Cr", "铬","Mn", "锰","Fe", "铁","Co", "钴","Ni", "镍","Cu", "铜","Zn", "锌",
      "Ga", "镓","Ge", "锗","As", "砷","Se", "硒","Br", "溴","Kr", "氪","Rb", "铷","Sr", "锶",
      "Y", "钇","Zr", "锆","Nb", "铌","Mo", "钼","Tc", "锝","Ru", "钌","Rh", "铑","Pd", "钯",
      ...
      "Lr", "铹","Rf", "𬬻","Db", "𬭊","Sg", "𬭳","Bh", "𬭛","Hs", "𬭶","Mt", "鿏","Ds", "𫟼",
